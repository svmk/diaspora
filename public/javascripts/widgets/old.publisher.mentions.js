 ...
 */
  ...
  Mentions.prototype.onSelect = function(visibleInput, data, formatted) {
    ...
    this.oldInputContent = visibleInput.val();

    var newHiddenInputValue = this.mentionList.generateHiddenInput(this._superclass.input.val());
    this._superclass.hiddenInput.val(newHiddenInputValue);
  };


  Mentions.prototype.mentionList = {
    mentions: [],
    sortedMentions : function(m1, m2) {
